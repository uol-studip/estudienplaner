...
class ZsbAblaufplanController extends ApplicationController {
    ...
    public function ablaufplan_action() {
        if (Request::get("delete_x") && Request::get("verlaufsplan_id")) {
            $profil = new StgBereich(Request::get("verlaufsplan_id"));
            $profil->delete();
    ...
    protected function details($bereichs_id) {
        ...
        if (Request::get("absenden_x") || Request::get("delete_dokument_typ_x") || Request::get("create_x")) {
            ...
            $this->bereich['sichtbar_fsb'] = Request::get('sichtbar_fsb');
            $this->bereich['sichtbar_pamt'] = Request::get('sichtbar_pamt');
            $this->bereich['sichtbar_iamt'] = Request::get('sichtbar_iamt');
