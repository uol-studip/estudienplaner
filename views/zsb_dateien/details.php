...
<div class="accordion">
    ...
    <div>
        ...
        <a class="icon_folder-empty" onClick="jQuery(this).hide().next().show(); STUDIP.MultiSelect.create('#verknuepfte_studiengaenge', '<?= _("Studieng�nge") ?>'); return false;"><?= _("Gro�es Auswahlfeld anzeigen") ?></a>
