    ...
    */
    ...
    recalculateKP: function () {
        ...
        jQuery('#studyplan').find('tr').each(function () {
            ...
            //wie ist das mit Modulen, die über zwei Semester gehen? Die werden jetzt
            //nur den höheren angerechnet (es sei denn, ich irre mich).
    ...
    droppedOnMe: function (element, event, ui) {
        ...
        //im Verlauf selbst stören diese spans nur
